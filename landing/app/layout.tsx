  ...
  "@graph": [
    {
      ...
      name: "Preclaude",
      description:
        "Open-source enhancement pack for Claude Code: 47 slash commands, 19 specialist agents, 13 auto-loading skills, and the Ralph autonomous build loop — production-ready workflows from kickoff to launch.",
      url: "https://preclaude.com",
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Preclaude is a pre-configured setup for Claude Code that includes 47 slash commands, 19 specialist agents, 13 auto-loading skills, and Ralph - an autonomous builder. It supercharges your Claude Code experience with production-ready workflows.",
          },
        },
        {
          "@type": "Question",
